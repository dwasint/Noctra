...
/atom/movable/screen/act_intent/rogintent/proc/update(list/left_intents, list/right_intents, active = FALSE)
	...
	for(var/datum/intent/intenty as anything in used)
		...
		switch(lol)
			if(1)
				intent1 = image(icon='icons/mob/roguehud.dmi',icon_state=intenty.icon_state, pixel_x = 128, pixel_y = 32, layer = layer+0.02)
			if(2)
				intent2 = image(icon='icons/mob/roguehud.dmi',icon_state=intenty.icon_state, pixel_x = 192, pixel_y = 32, layer = layer+0.02)
			if(3)
				intent3 = image(icon='icons/mob/roguehud.dmi',icon_state=intenty.icon_state, pixel_x = 128, layer = layer+0.02)
			if(4)
				intent4 = image(icon='icons/mob/roguehud.dmi',icon_state=intenty.icon_state, pixel_x = 192, layer = layer+0.02)
	if(ismob(usr))
		var/mob/M = usr
...
/atom/movable/screen/act_intent/rogintent/switch_intent(r_index, l_index)
	...
	switch(used_index)
		if(1)
			border1 = image(icon='icons/mob/roguehud.dmi', icon_state="intentselected", pixel_x = 128, pixel_y = 32, layer = layer+0.01)
		if(2)
			border1 = image(icon='icons/mob/roguehud.dmi', icon_state="intentselected", pixel_x = 192, pixel_y = 32, layer = layer+0.01)
		if(3)
			border1 = image(icon='icons/mob/roguehud.dmi', icon_state="intentselected", pixel_x = 128, layer = layer+0.01)
		if(4)
			border1 = image(icon='icons/mob/roguehud.dmi', icon_state="intentselected", pixel_x = 192, layer = layer+0.01)
	switch(other)
		if(1)
			border2 = image(icon='icons/mob/roguehud.dmi', icon_state=used, pixel_x = 128, pixel_y = 32, layer = layer+0.01)
		if(2)
			border2 = image(icon='icons/mob/roguehud.dmi', icon_state=used, pixel_x = 192, pixel_y = 32, layer = layer+0.01)
		if(3)
			border2 = image(icon='icons/mob/roguehud.dmi', icon_state=used, pixel_x = 128, layer = layer+0.01)
		if(4)
			border2 = image(icon='icons/mob/roguehud.dmi', icon_state=used, pixel_x = 192, layer = layer+0.01)
	update_appearance(UPDATE_OVERLAYS)
